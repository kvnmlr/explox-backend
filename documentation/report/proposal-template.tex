...
Two participants liked the color scheme, four found it suitable, while one of them liked the ressemblance to Strava, and only one person found it boring, e.g. because of the color orange that appears in Strava, the font of the UI, buttons and route visualization.
