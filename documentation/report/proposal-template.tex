...
\begin{itemize}
\item H1: Using our systems, athletes can find unexplored routes.
\item H2: Our map visualizations are suitable to display athletes' past activities.
\item H3: The way we present the functionalities is appropriate and leads to a good usability.
\end{itemize}
