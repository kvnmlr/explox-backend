...
, an android app that allows for route creation and exploration of less frequented areas.With this we want to enable the user to generate a more holistic image of their living surroundings and allow them to escape their daily routine. \textbf{}
\end{abstract}
...
\category{H.5.m.}{Information Interfaces and Presentation
 ...
 \begin{comment}\keywords{\plainkeywords}
  \end{comment}
\section{Keywords}
 Route planning;
